#!/bin/bash
#SBATCH --job-name=bench_scan_fine
#SBATCH --partition=gpu-bf
#SBATCH --gres=gpu:l40:1
#SBATCH --mem=48g
#SBATCH --cpus-per-task=8
#SBATCH --time=02:30:00
#SBATCH --output=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/bench_scan_fine_%j.stdout
#SBATCH --error=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/bench_scan_fine_%j.stderr
set -eu
...
OUT=/home/woodbuse/for/rflatent/original_theozymes/pte/mlff_outputs/ts_pipeline/benchmark_06h/scan_fine
...
apptainer exec --nv \
    ...
    python tools/scan_along_s.py \
        ...
        --s-min -0.5 --s-max 0.5 --sum-target 4.25 --n-points 11 \
