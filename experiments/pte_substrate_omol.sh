#!/bin/bash
#SBATCH --job-name=neb_substrate_omol
#SBATCH --partition=gpu
#SBATCH --gres=gpu:a6000:1
#SBATCH --mem=32g
#SBATCH --cpus-per-task=8
#SBATCH --time=05:59:00
#SBATCH --output=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/pte_substrate_omol_%j.stdout
#SBATCH --error=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/pte_substrate_omol_%j.stderr
cd /home/woodbuse/codebase_projects/quantum_cowboy_biochemistry
echo "Substrate uncatalyzed NEB (MACE-OMOL XL, A6000) | $(date)"
...
apptainer exec --nv --bind /home:/home --bind /mnt:/mnt --bind /net:/net \
    ...
    python scripts/run_neb_ts.py /home/woodbuse/for/rflatent/original_theozymes/pte/mlff_inputs/substrate_uncat_hydrolysis_TS__O1nuc_P1_O5lg__netCHG_minus_1.pdb \
        --outdir /home/woodbuse/for/rflatent/original_theozymes/pte/mlff_outputs/substrate_uncat_hydrolysis_TS__O1nuc_P1_O5lg__netCHG_minus_1_omol \
        --model mace-omol \
        --mode standard \
