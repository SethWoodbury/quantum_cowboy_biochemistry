#!/bin/bash
#SBATCH --job-name=ts_cv_K1c10_l40
#SBATCH --partition=gpu-bf
#SBATCH --gres=gpu:l40:1
#SBATCH --mem=64g
#SBATCH --cpus-per-task=8
#SBATCH --time=07:55:00
#SBATCH --output=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/ts_cv_K1c10_l40_%j.stdout
#SBATCH --error=/home/woodbuse/codebase_projects/quantum_cowboy_biochemistry/logs/ts_cv_K1c10_l40_%j.stderr
#
...
OUTDIR=/home/woodbuse/for/rflatent/original_theozymes/pte/qcb_runs/ts_cvspring_KCX_set1_conf10_l40
mkdir -p "$OUTDIR"

echo "=== ts_cv_K1c10_l40  $(date) ==="
echo "host: $(hostname)"
