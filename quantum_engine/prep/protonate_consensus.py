...
Usage
-----
    from quantum_engine.prep.protonate_consensus import consensus_protonate
...
log = logging.getLogger("quantum_engine.prep.protonate_consensus")
...
def _run_chimera_method(
    ...
    try:
        from quantum_engine.prep.protonate_chimera import add_hydrogens_with_charges
